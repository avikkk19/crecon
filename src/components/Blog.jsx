...
function Blog() {
  ...
  // Fix for the startChatWithAuthor function
  function startChatWithAuthor(blog, authorId) {
    ...
    // Fix: Use the correct path format for chat navigation
    navigate(`/chat/${authorId}?blogId=${blog.id}`);
  }
  ...
  return (
    <div className="min-h-screen  text-gray-300 bg-[radial-gradient(ellipse_at_center,_#0f172a_10%,_#042f2e_100%,_#000000_100%)] ">
      {/* Header */}
      <header className="bg-transparent shadow-md p-4 border-b border-gray-700 ">
        <div className="max-w-6xl mx-auto flex justify-between items-center mt-18">
          <h1 className="text-2xl font-bold text-white">Community Blog</h1>
          <div className="flex items-center space-x-4">
            <p className="text-xs font-light">Logged in as: {session.user.email}</p>
            <button
              onClick={() => supabase.auth.signOut()}
              className="text-white hover:text-red-300 text-sm bg-black p-2 rounded-3xl"
            >
              Sign Out
            </button>
            <a
              href="/chat"
              className="text-zinc-100 hover:text-black hover:bg-white text-sm bg-black p-2 rounded-3xl"
            >
              Go to Chat
            </a>
          </div>
        ...
        {!creating && !selectedBlog && (
          <div className="mb-6 flex justify-end">
            <button
              ...
              className="bg-black hover:bg-zinc-900 text-white px-4 py-2 rounded-3xl"
            >
            ...
            <form onSubmit={handleSubmitBlog}>
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button
                  ...
                  className="bg-black hover:bg-zinc-900 text-white px-6 py-2 rounded-lg disabled:opacity-90"
                >
                  {uploading || creating ? (
                    <div className="flex items-center">
                      {/* <svg
              ...
              <div className="flex items-center mb-6 text-gray-400">
                ...
                {selectedBlog.author_id !== session.user.id && (
                  <button
                    ...
                    className="ml-auto bg-black hover:bg-zinc-900 text-white px-4 py-2 rounded-xl flex items-center"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 mr-2"
                ...
                >
                  ...
                  <div className="p-5 flex-1 flex flex-col">
                    ...
                    <div className="flex mt-3 space-x-2">
                      <button
                        onClick={() => openBlogDetail(blog)}
                        className="flex-1 bg-zinc-900 hover:bg-zinc-800 text-white py-1 px-3 rounded-lg text-sm flex items-center justify-center"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
